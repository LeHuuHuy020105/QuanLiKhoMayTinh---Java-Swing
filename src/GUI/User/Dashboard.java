...
import GUI.User.NhanVien.BanHang;
import GUI.User.NhapHang.NhapHangForm;
import GUI.User.PhieuNhap.PhieuNhapForm;
import GUI.User.PhieuXuat.PhieuXuatForm;
import GUI.User.QLTaiKhoanAdmin.QLTaiKhoanForm;
import GUI.User.QLTaiKhoanNguoiDung.QLTaiKhoanNguoiDungForm;
import GUI.User.QuanLiChiNhanh.NhapHangBranchForm;
import GUI.User.QuanLiChiNhanh.PhieuNhapBranchForm;
import GUI.User.SanPham.SanPhamForm;
import GUI.User.ThongKe.ThongKeForm;
import GUI.User.TonKho.TonKhoForm;
import GUI.User.XuatHang.XuatHangForm;
    ...
    public void Display(String item){
        ...
        switch (item){
            ...
            case "Tài khoản user":
                ...
                break;
            case "Thống kê":
                ThongKeForm thongKeForm = new ThongKeForm(currentUser);
