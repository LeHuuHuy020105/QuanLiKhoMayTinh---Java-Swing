...
public class ChiTietBillForm extends JFrame {

    private static final long serialVersionUID = 1L;
    private JPanel contentPane;
    private JTable table_ChiTietPhieuNhap;
    private ThongKePhieuForm thongKePhieuForm;
    ...
    public ChiTietBillForm(ThongKePhieuForm thongKePhieuForm) {
        ...
        label_vaiTroNguoiTaoPhieu.setBounds(599, 94, 120, 28);
    ...
    public void XuatPDFHoaDon() {
        writePDF.getInstance().writeHoaDonKhachHang(thongKePhieuForm.getBillSelected().getMaPhieu());
    }
    ...
    public void updateDataToTable(ArrayList<DetailBill> detailBills) {
        DecimalFormat df = new DecimalFormat("#,###");
