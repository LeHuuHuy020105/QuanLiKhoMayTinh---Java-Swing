...
public class SuaTaiKhoanForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SuaTaiKhoanForm frame = new SuaTaiKhoanForm();
	...
	public SuaTaiKhoanForm() {
		...
		btnNewButton_2_1.setBounds(10, 535, 131, 41);
		...
		btnNewButton_2_1_1.setBounds(199, 535, 139, 41);
		contentPane.add(btnNewButton_2_1_1);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(10, 391, 328, 28);
		...
		comboBox_1.setBounds(10, 476, 328, 28);
