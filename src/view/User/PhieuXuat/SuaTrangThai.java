...
public class SuaTrangThai extends JFrame {
	 ...
	 * Create the frame.
	 */
	public SuaTrangThai(PhieuXuatForm phieuXuatForm) {
		...
		String [] trangThai = new String [] {"Chờ xác nhận","Đang chuẩn bị hàng","Đã bàn giao cho đơn vị vận chuyển","Vận chuyển","Hoàn thành"};
