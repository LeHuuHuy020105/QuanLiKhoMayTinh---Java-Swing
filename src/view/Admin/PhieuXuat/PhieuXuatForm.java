...
public class PhieuXuatForm extends JPanel {
	...
	public PhieuXuatForm() {
		...
		verticalBox_1_2.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "T\u00ECm ki\u1EBFm", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.BOLD, 12), new Color(0, 0, 0)));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"STT", "Mã phiếu xuất", "Nhà cung cấp", "Người tạo", "Thời gian tạo", "Tổng tiền"
			}
		));
